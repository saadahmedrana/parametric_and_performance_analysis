...
fprintf('The value of Convergence is %.3f and of Eff is %.3f\n', Convergence1,W);
% figure(2)
...
figure(1)
hold ON
plot(total_array(:,3),total_array(:,2),'r--')
