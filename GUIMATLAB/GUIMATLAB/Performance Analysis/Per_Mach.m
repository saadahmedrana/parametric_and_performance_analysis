function [net_thrust_array , sfc_array] = Per_Mach(mach_1 , mach_2 , altitude, comp_ratio)
num = int8((mach_2 - mach_1)*10)+1;
Temp = zeros(5,1);
Press = zeros(5,1);
s_vol = zeros(5,1);
s_entro = zeros(5,1);
...
figure(1)
plot(Mach_Array(i,:), net_thrust_array(i,:) ,'-o')
hold on
title('Net Thrust vs Mach')
xlabel('Mach')
ylabel('Net Thrust / N ')
...
figure(3)
plot(Mach_Array(i,:) , spec_net_thrust_array(i,:) ,'-o')
hold on
title('Specific Net Thrust vs Mach')
xlabel('Mach')
ylabel('Spec Net Thrust / N.s/kg ')

figure(4)
plot(Mach_Array(i,:) , sfc_array(i,:) ,'-o')
hold on
title('Specific Fuel Comsumption vs Mach')
xlabel('Mach')
ylabel('Specific Fuel Comsumption (SFC) / kg/s/N ')

figure(5)
plot(Mach_Array(i,:) , air_mass_array(i,:) ,'-o')
hold on
title('Inlet Air Flow vs Mach')
xlabel('Mach')
