function Iteration_TJ2_Experiment
...
while aaa == 0 && (picg1 <= pi_max) && p_hat >=0
picg1=guess;
delta_a=0;
...
% if Convergence1 >= 0.05 && (A1>B1)
%     guess = guess - 0.005;
% elseif Convergence1 >= 0.05 && (A1<B1)
%     guess = guess + 0.005;
% else
%     aaa = 1;
...
fprintf('The value of Convergence is %.3f and guess is %f\n', Convergence1, guess);
figure(2)
hold ON
plot(guess,Y,'r*')
